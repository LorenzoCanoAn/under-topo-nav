...
TILE_DEFINITION_FILE_PATH = "/home/lorenzo/catkin_ws/src/lorenzo/dataset_generation/scripts/world_file_generation/text files/tile_definition.txt"
BOILERPLATE_FILE_PATH = "/home/lorenzo/catkin_ws/src/lorenzo/dataset_generation/scripts/world_file_generation/text files/boilerplate.txt"
...
class TileTree:
    ...
    def to_world_file_text(self, filename):
        complete_text = ""
...
class Tile:
    ...
    def init_parameters(self):
        ...
        self.xml_path = "/home/lorenzo/catkin_ws/src/subt_gazebo/models/{}/model.sdf".format(
            self.model_name.replace("model://", ""))
    ...
    def calc_ang_vector_from_robot_pose(self, pose: ros_geom_msgs.Pose):
        ...
        for ext in exits_all:
            ...
            if r_angles[1] - r_angles[0] < 180:
                aperture = r_angles[1]-r_angles[0]
                center = (r_angles[1] + r_angles[0])/2

            else:
                aperture = 360 - (r_angles[1]-r_angles[0])
...
class intersection_t(Tile):
    color = "orange"
    model_name = "model://tunnel_intersection_t"
    ...
    # inter area1
    areas_points.append([(-0.86, 6.35), (0.86, 6.35), (0.86, 4.02), (-0.86, 4.02)])
    ...
    # inter area3
    areas_points.append([(1.56-5.5,6.46), (1.56-5.5,8.40), (4-5.5,8.40), (4-5.5,6.46)])
...
class intersection(Tile):
    color = "yellow"
    model_name = "model://tunnel_tile_1"
    ...
    # Transition Areas
    areas_points.append(((-0.7,-1.54), (0.7,-1.54), (0.7, -3.54), (-0.7, -3.54)))
    areas_points.append(rotate_list_of_tuple_points(areas_points[-1], 90))
    areas_points.append(rotate_list_of_tuple_points(areas_points[-1], 90))
    areas_points.append(rotate_list_of_tuple_points(areas_points[-1], 90))
...
class curve(Tile):
    color = "green"
    model_name = "model://tunnel_tile_2"
    p_connection_possitions = [(0,     -10,    0,      np.pi*3/2),
                               (10,    0,      0,      0)]
...
class rect(Tile):
    color = "blue"
    model_name = "model://tunnel_tile_5"
    p_connection_possitions = [(0,     -10,    0,      np.pi*3/2),
                               (0,     10,     0,      np.pi/2)]

    plot_segments = (((2, -10), (2, 10)),
                     ((-2, -10), (-2, 10)))
    areas_points = []
    areas_exits = []

    es = [((1.75, -9.60), (-1.75, -9.50))]
    es.append(((1.75, 9.60), (-1.75, 9.50)))
    es.append(((1.75, -3.0), (-1.75, -3.0)))
    es.append(((1.75, 3.00), (-1.75, 3.00)))

    areas_points.append(((1.75, -9.60), (-1.75, -9.50),
                        (-1.75, -3.00), (1.75, -3.00)))
    areas_points.append(
        ((1.75, 9.60), (-1.75, 9.50), (-1.75, 3.0), (1.75, 3.0)))
    areas_points.append(((1.75, 3.00), (-1.75, 3.00),
                        (-1.75, -3.0), (1.75, -3.0)))
...
class EndOfGallery(Tile):
    model_name = "model://tunnel_tile_blocker"
    color = "black"
    p_connection_possitions = [(0,     3,      0,      np.pi/2)]

    plot_segments = ()
    plot_segments = (((4, -4), (4, 4)), ((-4, -4), (-4, 4)),
                     ((4, -4), (-4, -4)))
    ...
    areas_points.append([(1.9, 7.5), (1.9, 4.45), (-1.9, 4.45), (-1.9, 7.5)])
    areas_exits.append(([0]))
    exit_to_areas_relation = [0]
